...
{  public:
    int pid;
    int ttl,tll,ttc,tlc;
    //ttl=total time limit , tll=total line limit, ttc= total time count ,tlc= total line count
...
//  To Display a two line termination message on the screen
...
{   term=1; cout<<"In terminate function . . ."<<endl;
    switch(a)
    {
        ...
        case 1:
                cout<<"\nError (1000) :Out Of Data Error"<<endl;
                cout<<"Program Terminated Abnormally"<<endl;
                strcpy(err,"Out of Data Error");
                terminateFun(err);
                break;
        case 2: //working
                cout<<"\nError(2000) :Line limit Exceeded"<<endl;
                cout<<"Program Terminated Abnormally"<<endl;
                strcpy(err,"Line limit exceeded");
                break;
        case 3:  //working
                cout<<"\n Error(3000) :Time Limit Exceeded"<<endl;
                cout<<"Program Terminated Abnormally"<<endl;
                strcpy(err,"Time limit exceeded");
                break;
        case 4: //working
                cout<<"\n Error(4000) :Operation Code Error"<<endl;
                cout<<"Program Terminated Abnormally"<<endl;
                strcpy(err,"Operation code error");
                break;
        case 5: //working
                cout<<"\n Error(5000) :Operand Error"<<endl;
                cout<<"Program Terminated Abnormally"<<endl;
                strcpy(err,"Operand error");
                break;
        case 6: //working
                cout<<"\n Error (6000) :Invalid Page Fault"<<endl;
                cout<<"Program Terminated Abnormally"<<endl;
...
{ string s;
	...
	if(rfcount==0)
	{
	   getline(fin,str);  cout<<"String : " <<str<<endl;
	   rfcount++;
	}
        else
         {  getline(fin,s);
...
{  cout<<"Buffsize = "<<buffsize<<endl;
    ...
    for(ic=0;ic<buffsize;)
      ...
      cout<<"pi= "<<PI<<endl;
        ...
        {   addMap(num);
            ...
            for(int l=0;l<4;l++)
                mem[RA][l]=r[l];
                cout<<"Content of memory location "<<RA<<endl;
             for(int l=0;l<4;l++)
                cout<<mem[RA][l];
   ...
   ic=ic+1;
   cout<<"IC value after incrementing: "<<ic<<endl;
